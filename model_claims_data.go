...
func (o *ClaimsData) GetIss() string {
	if o == nil || o.Iss == nil {
		var ret string
		return ret
	}
...
func (o ClaimsData) MarshalJSON() ([]byte, error) {
...
type NullableClaimsData struct {
	value *ClaimsData
	isSet bool
}

func (v NullableClaimsData) Get() *ClaimsData {
	return v.value
}

func (v *NullableClaimsData) Set(val *ClaimsData) {
	v.value = val
	v.isSet = true
}

func (v NullableClaimsData) IsSet() bool {
	return v.isSet
}

func (v *NullableClaimsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClaimsData(val *ClaimsData) *NullableClaimsData {
	return &NullableClaimsData{value: val, isSet: true}
}

func (v NullableClaimsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClaimsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
